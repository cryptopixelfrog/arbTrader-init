...
async function getExchangeRate () {
  ...
  let baseAmount = 100; // means $1000 for DAI and USDT
  ...
  //
  // let endTx = await arbTraderInstance.methods._swapOnOneSplit(
  //   toToken,
  //   fromToken,
  //   usdtBalance,
  //   parts,
  ...
  let startTx = await arbTraderInstance.methods.trade(
    fromToken,
    toToken,
    fromAmount,
    parts,
